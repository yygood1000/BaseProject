...
public class CustomTabLayout extends FrameLayout {
    ...
    private void readAttr(Context context, AttributeSet attrs) {
        ...
        mSelectIndicatorColor = typedArray.getColor(R.styleable.CustomTabLayout_tabIndicatorColor,
                context.getResources().getColor(R.color.colorAccent));
        mUnSelectTextColor = typedArray.getColor(R.styleable.CustomTabLayout_tabTextColor, Color.parseColor("#666666"));
        mSelectTextColor = typedArray.getColor(R.styleable.CustomTabLayout_tabSelectTextColor,
                context.getResources().getColor(R.color.colorAccent));
        ...
        mTabTextSize = typedArray.getDimensionPixelSize(R.styleable.CustomTabLayout_tabTextSize, 13);
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                for (int i = 0; i < mTabLayout.getTabCount(); i++) {
                    ...
                    if (i == tab.getPosition()) { // 选中状态
                        ...
                        indicator.setBackground(AppCompatResources.getDrawable(context,R.drawable.shape_indecator));
    ...
    public static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public ViewPagerOnTabSelectedListener(ViewPager viewPager, CustomTabLayout CustomTabLayout) {
            ...
            mTabLayoutRef = new WeakReference<CustomTabLayout>(CustomTabLayout);
        }
